...
#include "sys.h"
#include "stm32f4xx.h"
#define XPT2046_CS 		PBout(6)
#define XPT2046_CLK 	PBout(7)
#define XPT2046_MOSI 	PBout(9)
...
#define             XPT2046_PENIRQ_Read()                          (!!((int)(GPIOE->IDR & 0x10))) //pe4
...
#define             XPT2046_CS_ENABLE()                          (XPT2046_CS = 1)
#define             XPT2046_CS_DISABLE()                         (XPT2046_CS = 0)

#define             XPT2046_CLK_HIGH()                           (XPT2046_CLK = 1) 
#define             XPT2046_CLK_LOW()                            (XPT2046_CLK = 0)

#define             XPT2046_MOSI_1()                             (XPT2046_MOSI = 1)
#define             XPT2046_MOSI_0()                             (XPT2046_MOSI = 0)

#define             XPT2046_MISO()                               (!!((int)(GPIOB->IDR & 0x100))) //pb8
