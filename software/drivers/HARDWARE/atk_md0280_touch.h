...
/* 引脚定义 */
#define ATK_MD0280_TOUCH_PEN_GPIO_PORT          GPIOH
#define ATK_MD0280_TOUCH_PEN_GPIO_PIN           GPIO_PIN_7
#define ATK_MD0280_TOUCH_PEN_GPIO_CLK_ENABLE()  do{ __HAL_RCC_GPIOH_CLK_ENABLE(); }while(0)
